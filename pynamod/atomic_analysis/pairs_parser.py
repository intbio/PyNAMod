...
-----
    ...
    for nucleotide in nucleotides[:-1]:
        ...
        if nucleotide.ind not in paired_nucl_ind and nucleotide.leading_strand:
            ...
            if prev_nucleotide and next_nucleotide and prev_nucleotide.ind in paired_nucl_ind and next_nucleotide.ind in paired_nucl_ind:
                if prev_nucleotide.ind in pairs.lead_nucl_inds:
                    partner_idx = pairs.lead_nucl_inds.index(prev_nucleotide.ind)
                    lag_ind1 = pairs.lag_nucl_inds[partner_idx]
                else:
                    partner_idx = pairs.lag_nucl_inds.index(prev_nucleotide.ind)
                    lag_ind1 = pairs.lead_nucl_inds[partner_idx]

                if next_nucleotide.ind in pairs.lead_nucl_inds:
                    partner_idx = pairs.lead_nucl_inds.index(next_nucleotide.ind)
                    lag_ind2 = pairs.lag_nucl_inds[partner_idx]
                else:
                    partner_idx = pairs.lag_nucl_inds.index(next_nucleotide.ind)
                    lag_ind2 = pairs.lead_nucl_inds[partner_idx]
