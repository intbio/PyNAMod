...
setup(
    ...
    packages=find_packages(exclude=['Examples', 'docs', 'tests*','deprecated']),
   
    # Versions should comply with PEP440. For single-sourced versioning, see
    # http://packaging.python.org/en/latest/tutorial.html#version
    version=version,

    description='A library for monipulating dsDNA structures',
    long_description=long_description,

    # The project URL.
    url='https://github.com/intbio/PyNAMod',
    ...
    keywords='science DNA bioinformatics',
